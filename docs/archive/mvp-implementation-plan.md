...
>
> **Gate registrado na época:** a auditoria documental da Fase 2 foi aprovada em 2026-08-03 e
...
[matriz de evidências F1](phase1-evidence.md). Casing do artefato,
...
Evidência: [validação e auditorias da Fase 2](phase2-validation.md).
...
[contrato, plano e conteúdo estático](phase2-validation.md) verdes. A
