...
func TestAllowlistExactlyMatchesDocumentedMVPIDs(t *testing.T) {
	want := []string{
		...
		"cronjobs.list", "cronjobs.get", "cronjobs.watch", "cronjobs.suspend", "cronjobs.runnow", "cronjobs.delete",
		...
		"namespaces.get",
		"replicasets.list", "replicasets.get", "replicasets.watch", "replicasets.delete",
