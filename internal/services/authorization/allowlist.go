...
var capabilityAllowlist = [...]CapabilitySpec{
	...
	{ID: "statefulsets.restart", APIGroup: "apps", Resource: "statefulsets", Verb: "patch", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	...
	{ID: "statefulsets.delete", APIGroup: "apps", Resource: "statefulsets", Verb: "delete", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	...
	{ID: "daemonsets.restart", APIGroup: "apps", Resource: "daemonsets", Verb: "patch", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "daemonsets.delete", APIGroup: "apps", Resource: "daemonsets", Verb: "delete", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	...
	{ID: "jobs.delete", APIGroup: "batch", Resource: "jobs", Verb: "delete", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	...
	{ID: "cronjobs.suspend", APIGroup: "batch", Resource: "cronjobs", Verb: "patch", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "cronjobs.runnow", APIGroup: "batch", Resource: "jobs", Verb: "create", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "cronjobs.delete", APIGroup: "batch", Resource: "cronjobs", Verb: "delete", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	...
	{ID: "replicasets.list", APIGroup: "apps", Resource: "replicasets", Verb: "list", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "replicasets.get", APIGroup: "apps", Resource: "replicasets", Verb: "get", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "replicasets.watch", APIGroup: "apps", Resource: "replicasets", Verb: "watch", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "replicasets.delete", APIGroup: "apps", Resource: "replicasets", Verb: "delete", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "horizontalpodautoscalers.list", APIGroup: "autoscaling", Resource: "horizontalpodautoscalers", Verb: "list", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "horizontalpodautoscalers.get", APIGroup: "autoscaling", Resource: "horizontalpodautoscalers", Verb: "get", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "poddisruptionbudgets.list", APIGroup: "policy", Resource: "poddisruptionbudgets", Verb: "list", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "poddisruptionbudgets.get", APIGroup: "policy", Resource: "poddisruptionbudgets", Verb: "get", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "resourcequotas.list", Resource: "resourcequotas", Verb: "list", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "resourcequotas.get", Resource: "resourcequotas", Verb: "get", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "limitranges.list", Resource: "limitranges", Verb: "list", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "limitranges.get", Resource: "limitranges", Verb: "get", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "serviceaccounts.list", Resource: "serviceaccounts", Verb: "list", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "serviceaccounts.get", Resource: "serviceaccounts", Verb: "get", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "roles.list", APIGroup: "rbac.authorization.k8s.io", Resource: "roles", Verb: "list", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "roles.get", APIGroup: "rbac.authorization.k8s.io", Resource: "roles", Verb: "get", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "rolebindings.list", APIGroup: "rbac.authorization.k8s.io", Resource: "rolebindings", Verb: "list", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "rolebindings.get", APIGroup: "rbac.authorization.k8s.io", Resource: "rolebindings", Verb: "get", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "clusterroles.list", APIGroup: "rbac.authorization.k8s.io", Resource: "clusterroles", Verb: "list", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "clusterroles.get", APIGroup: "rbac.authorization.k8s.io", Resource: "clusterroles", Verb: "get", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameTarget},
	{ID: "clusterrolebindings.list", APIGroup: "rbac.authorization.k8s.io", Resource: "clusterrolebindings", Verb: "list", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "clusterrolebindings.get", APIGroup: "rbac.authorization.k8s.io", Resource: "clusterrolebindings", Verb: "get", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameTarget},
	{ID: "customresourcedefinitions.list", APIGroup: "apiextensions.k8s.io", Resource: "customresourcedefinitions", Verb: "list", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "customresourcedefinitions.get", APIGroup: "apiextensions.k8s.io", Resource: "customresourcedefinitions", Verb: "get", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameTarget},
	{ID: "priorityclasses.list", APIGroup: "scheduling.k8s.io", Resource: "priorityclasses", Verb: "list", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "priorityclasses.get", APIGroup: "scheduling.k8s.io", Resource: "priorityclasses", Verb: "get", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameTarget},
	{ID: "runtimeclasses.list", APIGroup: "node.k8s.io", Resource: "runtimeclasses", Verb: "list", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "runtimeclasses.get", APIGroup: "node.k8s.io", Resource: "runtimeclasses", Verb: "get", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameTarget},
	{ID: "mutatingwebhookconfigurations.list", APIGroup: "admissionregistration.k8s.io", Resource: "mutatingwebhookconfigurations", Verb: "list", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "mutatingwebhookconfigurations.get", APIGroup: "admissionregistration.k8s.io", Resource: "mutatingwebhookconfigurations", Verb: "get", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameTarget},
	{ID: "validatingwebhookconfigurations.list", APIGroup: "admissionregistration.k8s.io", Resource: "validatingwebhookconfigurations", Verb: "list", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "validatingwebhookconfigurations.get", APIGroup: "admissionregistration.k8s.io", Resource: "validatingwebhookconfigurations", Verb: "get", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameTarget},
	{ID: "ingressclasses.list", APIGroup: "networking.k8s.io", Resource: "ingressclasses", Verb: "list", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "ingressclasses.get", APIGroup: "networking.k8s.io", Resource: "ingressclasses", Verb: "get", Scope: ScopeCluster, ResourceNamePolicy: ResourceNameTarget},
	{ID: "networkpolicies.list", APIGroup: "networking.k8s.io", Resource: "networkpolicies", Verb: "list", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "networkpolicies.get", APIGroup: "networking.k8s.io", Resource: "networkpolicies", Verb: "get", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
	{ID: "endpoints.list", Resource: "endpoints", Verb: "list", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameEmpty},
	{ID: "endpoints.get", Resource: "endpoints", Verb: "get", Scope: ScopeNamespace, ResourceNamePolicy: ResourceNameTarget},
