...
func TestFavoriteSetValidation(t *testing.T) {
	tests := []struct {
		...
		{name: "cluster-scoped favorite has empty namespace", set: FavoriteSet{Version: 1, Items: []FavoriteItem{{ID: "f1", Kind: "node", Name: "worker-1"}}}, invalid: false},
		{name: "unknown kind", set: FavoriteSet{Version: 1, Items: []FavoriteItem{{ID: "f1", Kind: "deployment-legacy", Namespace: "ops", Name: "worker"}}}, invalid: true},
