...
## Changed
- add: v0.7
- docs(plan): add phased v1 execution plan [skip ci]
- remove file
...
## Full Changelog
**Full Changelog**: https://github.com/fvmoraes/kubepeep/compare/0.6.1...0.6.2
...
## Added
- feat(ux): global namespace filter, resource workspace and bulk actions
- feat(actions): extend workload mutations with restart, delete and cronjob control
...
## Full Changelog
**Full Changelog**: https://github.com/fvmoraes/kubepeep/compare/0.5.0...0.6.0

## [0.5.0] - 2026-09-05

## Added
- feat(ux): cluster namespace picker and session heal for generation changes
...
## Full Changelog
**Full Changelog**: https://github.com/fvmoraes/kubepeep/compare/0.4.3...0.5.0
...
## Fixed
- fix(ux): namespace editor empty-state guidance and correct window title
...
## Full Changelog
**Full Changelog**: https://github.com/fvmoraes/kubepeep/compare/0.4.1...0.4.2
