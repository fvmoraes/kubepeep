...
- [ ] **F2-03 — Watches compartilhados.** Um watch por identidade completa de C03, sem misturar selectors, namespaces ou gerações, com ref count + idle timeout (30–60 s) para encerrar; navegar entre telas que consomem o mesmo recurso não derruba nem reabre watch a cada troca. Compartilhamento, timeout e identidade de DELETE de Events implementados/testados; falta medir a troca de telas ponta a ponta.
