...
- [ ] **F3-04 — Sem flicker.** `placeholderData`/`previousData` em mudança de sort, página e refresh: dados anteriores permanecem visíveis + indicador sutil de "Refreshing…".
...
| mudar sort / refresh | tabela anterior permanece + indicador sutil; sem flicker |
