...
6. `meta.page.filterScope` continua descrevendo filtro/ordenação. As estratégias de paginação não expõem estado interno ao frontend; o cursor permanece opaco.
