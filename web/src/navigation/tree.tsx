...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'endpoints', label: 'Endpoints', path: '/network/endpoints', icon: ArrowLeftRight, tip: 'Endpoints' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'roles', label: 'Roles', path: '/access/roles', icon: KeyRound, tip: 'Roles' },
      { id: 'role-bindings', label: 'RoleBindings', path: '/access/role-bindings', icon: KeyRound, tip: 'Role Bindings' },
      { id: 'cluster-roles', label: 'ClusterRoles', path: '/access/cluster-roles', icon: KeyRound, tip: 'Cluster Roles' },
      { id: 'cluster-role-bindings', label: 'ClusterRoleBindings', path: '/access/cluster-role-bindings', icon: KeyRound, tip: 'Cluster Role Bindings' },
