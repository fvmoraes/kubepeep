...
describe('application shell', () => {
  ...
  it('exposes the exact static application routes in the topbar command center', () => {
    ...
    expect(screen.getAllByRole('option').map((option) => option.textContent)).toEqual([
      ...
      expect.stringContaining('ReplicaSets'),
      ...
      expect.stringContaining('LimitRanges'),
      expect.stringContaining('HorizontalPodAutoscalers'),
      expect.stringContaining('PodDisruptionBudgets'),
      ...
      expect.stringContaining('ServiceAccounts'),
      expect.stringContaining('Roles'),
      expect.stringContaining('RoleBindings'),
      expect.stringContaining('ClusterRoles'),
      expect.stringContaining('ClusterRoleBindings'),
